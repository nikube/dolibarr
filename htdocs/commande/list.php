...
$search_fk_cond_reglement = GETPOST('search_fk_cond_reglement', 'array:intcomma');	// Array from the multiselect combo. A scalar value (old links, saved filters) is converted into an array by GETPOST.
$search_fk_shipping_method = GETPOST('search_fk_shipping_method', 'intcomma');
$search_fk_mode_reglement = GETPOST('search_fk_mode_reglement', 'array:intcomma');	// Array from the multiselect combo. A scalar value (old links, saved filters) is converted into an array by GETPOST.
...
if (is_array($search_fk_cond_reglement) && count($search_fk_cond_reglement) > 0) {
...
if (is_array($search_fk_mode_reglement) && count($search_fk_mode_reglement) > 0) {
